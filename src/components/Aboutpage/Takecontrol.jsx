...
const Takecontrol = () => {
  return (
    <div className="bg-down flex xs:items-center justify-between xs:min-h-[25rem] xs:max-h-[27rem] lg:h-96 w-full my-28 rounded-md relative  lg:pt-14 px-10 overflow-hidden xs:text-center lg:text-left">
      <div className="xs:px-1 lg:px-10">
