...
const Work = () => {
  return (
    <div className="h-auto w-full flex flex-col items-center py-10">
      ...
      <div className="flex xs:flex-col lg:flex-row justify-center lg:gap-10 xs:min-h-96: lg:h-96 xs:bg-black lg:bg-work w-full rounded-lg">
        <div className="lg:w-[30%] flex flex-col items-center p-10 text-center justify-center">
      ...
      <p className="text-xl text-center lg:px-48 pt-10">
